...
goog.loadModule(function (exports) {
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    ...
    $templateAlias1({ items: opt_data.site.topbar, style: 'topbar-light topbar-docs', logo: { text: 'Liferay Culture Book', icon: 'icon-16-folder' } }, null, opt_ijData);
  ...
  function $topics(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Politics, Process and Benefits');
    ie_close('h1');
    ie_open('p', null, null, 'class', 'docs-home-top-description');
    itext('Everything you need to know in one place :)');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_open('div', null, null, 'class', 'row');
    ...
    itext('Choose a Country');
    ie_close('h2');
    ie_open('p', null, null, 'class', 'docs-home-middle-description');
    itext('Each one provide description for all Liferay Politics, Process and Benefits.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
    ...
    for (var childIdIndex295 = 0; childIdIndex295 < childIdListLen295; childIdIndex295++) {
      ...
      if (!topic__soy285.hidden) {
        ...
        ie_open('a', null, null, 'class', 'topic radial-out', 'href', topic__soy285.url);
        ie_open('div', null, null, 'class', 'topic-icon');
        ie_void('span', null, null, 'class', 'icon-16-' + topic__soy285.icon);
        ie_close('div');
        ie_open('h3', null, null, 'class', 'topic-title');
        var dyn21 = topic__soy285.title;
